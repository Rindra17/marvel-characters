...
export default function AddCharacter(props) {
  const { setShowAddForm, setCharacters } = props;
      ...
      >
        <div className={`relative w-1/4 font-text rounded bg-white text-black p-5 transform transition-all duration-200
          ...
          <div className="flex flex-col items-center">
            <h2 className="font-title text-xl">Add character</h2>
            <button
              onClick={handleClose}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-2">
              ...
              <div className="flex justify-around">
                <button type="submit" className="px-3 py-2 rounded bg-blue-600 text-white cursor-pointer hover:bg-blue-800 duration-100">
                  Add
                </button>
                <button type="button"
                  onClick={handleClose}
